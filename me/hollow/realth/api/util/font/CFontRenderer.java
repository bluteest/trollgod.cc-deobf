...
package me.hollow.realth.api.util.font;
...
public class CFontRenderer extends CFont
{
    ...
    public float drawCenteredString(final String text, final float x, final float y, final int color, final boolean shadow) {
