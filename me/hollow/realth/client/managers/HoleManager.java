...
public class HoleManager
{
    ...
    public ArrayList<HolePos> holes = new ArrayList<HolePos>();
    public Vec3i[] Hole = new Vec3i[] { new Vec3i(1, 0, 0), new Vec3i(-1, 0, 0), new Vec3i(0, -1, 0), new Vec3i(0, 0, 1), new Vec3i(0, 0, -1) };;
    public Vec3i[] DoubleHoleNorth = new Vec3i[] { new Vec3i(0, 0, -2), new Vec3i(-1, 0, -1), new Vec3i(1, 0, -1), new Vec3i(0, -1, -1), new Vec3i(0, -1, 0), new Vec3i(-1, 0, 0), new Vec3i(1, 0, 0), new Vec3i(0, 0, 1) };;
    public Vec3i[] DoubleHoleWest = new Vec3i[] { new Vec3i(-2, 0, 0), new Vec3i(-1, 0, 1), new Vec3i(-1, 0, -1), new Vec3i(-1, -1, 0), new Vec3i(0, -1, 0), new Vec3i(0, 0, 1), new Vec3i(0, 0, -1), new Vec3i(1, 0, 0) };;
