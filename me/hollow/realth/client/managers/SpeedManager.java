...
public class SpeedManager implements Util
{
    ...
    public Map<EntityPlayer, Double> playerSpeeds;
    ...
    public void updatePlayers() {
        for (int i = 0; i < SpeedManager.mc.world.playerEntities.size(); ++i) {
            final EntityPlayer player = SpeedManager.mc.world.playerEntities.get(i);
            if (SpeedManager.mc.player.getDistanceSq((Entity)player) < 400.0) {
